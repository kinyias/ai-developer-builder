      ...
      <CardContent className="p-0">
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem onClick={(e) => e.stopPropagation()}>Close ticket</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </TableCell>
              </TableRow>
        ...
        <div className="flex items-center justify-between border-t px-4 py-4">
          <div className="text-sm text-muted-foreground">
            ...
            <span className="font-medium">{Math.min(page * itemsPerPage, tickets.length)}</span> of{" "}
